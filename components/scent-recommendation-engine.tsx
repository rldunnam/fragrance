...
const fragrances: Fragrance[] = [
  ...
  },
  {
    ...
    house: 'Creed',
    price: 365,
    description: 'A clean, soapy, citrus-forward vetiver that uses leaves rather than roots for an unusually fresh, green approach. Ginger and bergamot open bright and sparkling before Haitian vetiver and Florentine iris emerge — earthy but refined, not harsh. Ambergris base adds warmth and depth. Closer in spirit to a luxury eau de cologne than a dark vetiver, and often compared to Mugler Cologne but with more natural quality and a gingery bite.',
    scentFamily: 'Fresh',
    ...
    rationale: 'Creed\'s unconventional take on vetiver — using the leaves rather than the root for a soapy, fresh green profile rather than dark earthiness. Uniquely versatile among Creed\'s lineup, suitable for office or casual wear across three seasons. Best for those who find classic vetiver too smoky or harsh but still want something distinguished.',
    intensity: 2,
    longevity: '7-9 hrs',
    sillage: 'Moderate',
    projection: 2,
  },
  {
    ...
    house: 'Emporio Armani',
    price: 130,
    description: 'The richest, most complex entry in the Stronger With You lineup. Rum and elemi open with a warm, slightly boozy sweetness; lavender and davana add herbal depth in the heart; cedar, vanilla, and patchouli create a rich, textured base. More mature and less sweet than the original, with an almost oriental depth. Reviewers call it the most "serious" SWY — a fall/winter powerhouse that projects for hours.',
    scentFamily: 'Oriental',
    topNotes: ['Rum', 'Elemi', 'Bergamot'],
    heartNotes: ['Lavender', 'Davana'],
    baseNotes: ['Madagascar Vanilla', 'Chestnut', 'Cedar', 'Patchouli'],
    occasions: ['Date Night', 'Evening', 'Special Occasion'],
    seasons: ['Fall', 'Winter'],
    rationale: 'The pinnacle of the SWY DNA — same chestnut-vanilla core as the original but with boozy rum and earthy patchouli making it significantly more complex and fall/winter appropriate. Beast-mode projection, genuine compliment-getter. The ideal upgrade for anyone who loves Stronger With You Intensely but wants something more sophisticated for colder months.',
    intensity: 4,
    longevity: '10-12 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    house: 'Louis Vuitton',
    price: 280,
    description: 'A modern luxury fresh fragrance built around an extraordinary Chinese black tea CO2 extraction and a heavy dose of Ambroxan. Opens with a bright burst of citron, Calabrian bergamot, and Sicilian orange, warmed by Nigerian ginger and Ceylon cinnamon. The tea note — dry, slightly smoky, aromatic — gives this freshie genuine distinction and longevity beyond the genre norm. Often described as the cleanest, most sophisticated citrus scent available at any price.',
    scentFamily: 'Fresh',
    ...
    occasions: ['Everyday', 'Office', 'Date Night'],
    seasons: ['Spring', 'Summer', 'Fall'],
    rationale: 'The "new Aventus" for fresh fragrance lovers — universally complimented, worn by everyone from executives to style icons. The Chinese black tea base gives it longevity and soul that other citrus freshies lack. Exclusive to Louis Vuitton directly; buy authentic only. A genuine investment piece for those who live in fresh-citrus territory.',
    intensity: 2,
    longevity: '8-10 hrs',
    sillage: 'Moderate',
    projection: 2,
  },
  {
    ...
    house: 'Paco Rabanne',
    price: 85,
    description: 'The most wearable and versatile entry in the 1 Million lineup. Green plum and grapefruit open fresh and slightly tart, quickly revealing a distinctive hazelnut-honey heart that is sweet but never cloying. Cedar, patchouli, and amberwood ground it with an earthy warmth. Far more subdued and casual than the original — less gold-brick swagger, more everyday confidence. Genuinely unisex in nature, popular with women as well.',
    scentFamily: 'Oriental',
    ...
    rationale: 'The flanker that eclipses the original in versatility — the hazelnut-plum combo is addictive and unique among mainstream fragrances. Perfectly positioned for casual-to-smart-casual occasions in cooler weather, unlike the original which skews louder and more formal. One of the most distinctive sweet-woody scents under $100.',
    intensity: 3,
    longevity: '7-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    house: 'Paco Rabanne',
    price: 120,
    description: 'A 2024 evolution of the iconic Invictus DNA into parfum concentration. Marine notes, lavender, and pink pepper open with the recognizable fresh-aquatic character, but cashmeran and sandalwood in the base add a warm, woody richness absent from earlier versions. Soapy and clean throughout — closer to a luxury body wash aesthetic done right. More mature than the original EDT, projecting confidently without the synthetic harshness that turned some away from earlier flankers.',
    scentFamily: 'Fresh',
    ...
    occasions: ['Everyday', 'Office', 'Date Night'],
    seasons: ['Spring', 'Summer', 'Fall'],
    rationale: 'The most refined interpretation of the Invictus DNA — takes the signature clean-aquatic character and elevates it with a warm sandalwood-cashmeran base. Clean, versatile, and office-appropriate year-round. Best for fans of soapy fresh-clean masculines who want something beyond Bleu de Chanel or Acqua di Gio without straying into niche territory.',
    intensity: 3,
    longevity: '7-9 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    house: 'Parfums de Marly',
    price: 305,
    description: 'Parfums de Marly\'s acclaimed gourmand-oriental. Cinnamon, honey, and osmanthus open with a spiced apple-pie warmth — festive but refined. The heart develops benzoin, labdanum, and davana for a boozy, resinous depth. Vanilla, tonka bean, and patchouli round the base into a luxuriously sweet but grounded oriental. Often compared to Kilian\'s Angel\'s Share and Hermès Ambre Narguile, but with a sharper cinnamon character and more masculine edge. A signature fall-winter statement piece.',
    scentFamily: 'Oriental',
    ...
    occasions: ['Date Night', 'Evening', 'Special Occasion'],
    seasons: ['Fall', 'Winter'],
    rationale: 'One of the most genuinely beloved PDM releases — the cinnamon-honey-osmanthus combination is distinctive among niche orientals, sitting between gourmand and spiced amber without fully being either. Extremely compliment-worthy at dinner events or holiday gatherings. Committed fall/winter only due to the spiced warmth; not a hot-weather scent.',
    intensity: 4,
    longevity: '9-11 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    house: 'Tom Ford',
    price: 220,
    description: 'The benchmark leather fragrance in the designer-to-premium range. Cardamom and jasmine sambac open with unexpected warmth and a floral brightness that softens the leather before it arrives. The leather accord — based on suederol — is unmistakable: clean new car seats, a luxury leather jacket, a high-end goods store. Patchouli and white moss add earthy depth; amber grounds the base with warmth. Unisex in practice despite masculine branding. Compared to Tuscan Leather but airier and more approachable.',
    scentFamily: 'Leather',
    topNotes: ['Cardamom'],
    heartNotes: ['Black Leather', 'Jasmine Sambac', 'White Moss'],
    baseNotes: ['Patchouli', 'Amber'],
    occasions: ['Date Night', 'Evening', 'Office'],
    seasons: ['Fall', 'Winter'],
    rationale: 'The gold standard for accessible leather fragrances — sophisticated enough to turn heads, wearable enough for office or date night. Tom Ford\'s Signature line pricing makes this a step below Private Blend but the quality overdelivers. If you want to own one definitive leather scent, this is the recommendation.',
    intensity: 3,
    longevity: '8-10 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    house: 'Versace',
    price: 85,
    description: 'A Mediterranean summer classic since 2006. Opens with a burst of white lemon, bergamot, and the distinctive starfruit note that gives it an almost juicy, exotic sweetness. Cedar, tarragon, and sage cool it into herbal territory in the heart; sycamore wood, amber, and musk bring subtle woody warmth to the dry-down. Lighter than Pour Homme, more tropical and beachy. An EDT that actually delivers decent longevity for its concentration, especially in heat.',
    scentFamily: 'Fresh',
    ...
    rationale: 'The go-to summer beach fragrance that\'s survived nearly 20 years for good reason — the starfruit-lemon opening is genuinely unique among mainstream freshies and the herbal dry-down is satisfying. Best bang-for-buck summer EDT from a luxury-adjacent designer brand. Blind buy safe for anyone who likes citrus-aquatic fragrances.',
    intensity: 2,
    longevity: '5-7 hrs',
    sillage: 'Light',
    projection: 2,
  },
  {
    ...
    house: 'YSL',
    price: 115,
    description: 'The fragrance that made fresh-blue mainstream again. Apple, ginger, and bergamot open with a signature juicy-sweet brightness; sage and juniper berries add a clean herbal sharpness in the heart. Amberwood, tonka bean, cedar, and vetiver build a warm, rounded base that keeps it out of generic blue territory. Often described as a luxury shower gel at its best — a "blue fragrance" with genuine character. One of the most complimented designer masculines of the last decade.',
    scentFamily: 'Fresh',
    topNotes: ['Apple', 'Ginger', 'Bergamot'],
    ...
    rationale: 'The crowd-pleasing, compliment-guaranteed cornerstone of any modern masculine collection. The apple-sage-amberwood trio is distinctive enough to avoid "generic blue" status while remaining universally appealing. True four-season versatility — offices, dates, casual wear. Y Le Parfum (already in catalog) is smoother; this one has a more energetic apple-forward opening.',
    intensity: 3,
    longevity: '8-10 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    house: 'YSL',
    price: 300,
    description: 'YSL\'s Le Vestiaire des Parfums flagship — a sophisticated patchouli-centered EDP relaunched in 2025 under the "Sharp Patchouli" name. Violet leaf, coriander, and bergamot open with a crisp, spicy green brightness. Rose and lily-of-the-valley provide a refined floral heart, sharpened by black pepper. Patchouli leads the base — earthy, woody, smoky but masterfully controlled — rounded with ambergris and bourbon vanilla. Elegant, unisex, and distinctive: patchouli for people who thought they didn\'t like patchouli.',
    scentFamily: 'Oriental',
    ...
    occasions: ['Date Night', 'Evening', 'Special Occasion'],
    seasons: ['Fall', 'Winter'],
    rationale: 'The most refined patchouli fragrance in a major designer\'s catalog — YSL\'s Le Vestiaire line approaches niche quality at designer pricing. Tuxedo Sharp Patchouli is at its best dressed up for formal occasions or cool evenings out. Unisex enough for any gender but carries an unmistakably authoritative, grown-up character. The YSL answer to the spiced-oriental niche market.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
