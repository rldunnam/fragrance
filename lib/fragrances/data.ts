...
export const fragrances: Fragrance[] = [
  {
    ...
    projection: 5,
    line: 'Sauvage',
    source: 'https://www.fragrantica.com/perfume/Dior/Sauvage-Elixir-68415.html',
    ingredients: [
      'Alcohol', 'Parfum (Fragrance)', 'Tetramethyl Acetyloctahydronaphthalenes',
      'Pogostemon Cablin Oil', 'Aqua (Water)', 'Lavandula Oil/Extract', 'Limonene', 'Linalool',
      'Linalyl Acetate', 'Coumarin', 'Citronellol', 'Vanillin', 'Pinene', 'Eugenol',
      'Butyl Methoxydibenzoylmethane', 'Beta-Caryophyllene', 'Camphor',
      'Citrus Aurantium Peel Oil', 'Terpineol', 'Terpinolene', 'Rose Ketones',
      'Cinnamomum Zeylanicum Bark Oil', 'Geranyl Acetate', 'Geraniol', 'Alpha-Terpinene',
      'Cinnamal', 'Citral', 'Rose Flower Oil/Extract', 'Isoeugenol', 'Benzyl Alcohol',
      'Carvone', 'CI 60730 (Ext. Violet 2)', 'Hexyl Cinnamal', 'CI 19140 (Yellow 5)',
      'CI 42090 (Blue 1)',
    ],
    ingredientsSource: 'https://www.dior.com/en_us/beauty/products/sauvage-elixir-Y0996460.html',
    formulaCode: '#21664',
  },
  {
    id: 'bleu-chanel',
  ...
  },
  {
    ...
    baseNotes: ['Vanilla', 'Cardamom', 'Sandalwood', 'Pepper', 'Guaiac Wood', 'Patchouli', 'Ambermax™', 'Coumarin'],
    ...
    projection: 5,
    line: 'Layton',
    source: 'https://www.fragrantica.com/perfume/Parfums-de-Marly/Layton-39314.html',
    ingredients: [
      'Alcohol Denat.', 'Parfum (Fragrance)', 'Aqua (Water/Eau)',
      'Tetramethyl Acetyloctahydronaphthalenes',
      'Citrus Aurantium Bergamia (Bergamot) Peel Oil', 'Linalyl Acetate', 'Limonene',
      'Pogostemon Cablin Oil', 'Vanillin', 'Benzyl Alcohol', 'Linalool', 'Coumarin',
      'Lavandula Oil/Extract', 'Pinene', 'Citronellol', 'Beta-Caryophyllene',
      'Pelargonium Graveolens Flower Oil', 'BHT', 'Terpinolene', 'Rose Ketones',
      'Geranyl Acetate', 'Camphor', 'Terpineol', 'Citral', 'Geraniol',
      'Citrus Aurantium Peel Oil', 'Alpha-Terpinene', 'Menthol',
    ],
    ingredientsSource: 'https://parfums-de-marly.com/products/layton',
  },
  {
    id: 'versace-eros',
    name: 'Eros',
  ...
  },
  {
    ...
    projection: 4,
    line: 'Eros',
    source: 'https://www.fragrantica.com/perfume/Versace/Eros-Eau-de-Parfum-62762.html',
    ingredients: [
      'Alcohol Denat. (Sd Alcohol 39-C)', 'Parfum (Fragrance)', 'Aqua (Water)', 'Limonene',
      'Linalool', 'Coumarin', 'Alpha-Isometyl Ionone', 'Citral', 'Citronellol', 'Geraniol',
      'Cinnamal', 'Eugenol',
    ],
    ingredientsSource: 'https://www.ulta.com/p/eros-eau-de-parfum-pimprod2019397',
  },
  {
    id: 'acqua-di-gio',
  ...
  },
  {
    ...
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Intensely-52802.html',
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau', 'Coumarin',
      'Diethylamino Hydroxybenzoyl Hexyl Benzoate', 'Limonene', 'Isoeugenol', 'Linalool',
      'Eugenol', 'Citronellol', 'Benzyl Alcohol', 'Citral', 'Cinnamal', 'CI 14700 / Red 4',
      'CI 15510 / Orange 4', 'Geraniol', 'Methyl 2-Octynoate', 'CI 60730 / Ext. Violet 2',
      'CI 42090 / Blue 1',
    ],
    ingredientsSource: 'https://www.ulta.com/p/emporio-armani-stronger-with-you-intensely-eau-de-parfum-pimprod2045709?sku=2628034',
    formulaCode: 'F.I.L. B267449/1',
  },
  {
    id: 'terre-hermes',
    name: 'Terre d\'Hermès',
  ...
  },
  {
    ...
    season: ['Fall', 'Winter'],
    topNotes: [],
    heartNotes: ['Vanilla', 'Tobacco', 'Cinnamon', 'Cumin', 'Bourbon Whiskey', 'Saffron'],
    baseNotes: [],
    ...
    sillage: 'Very Strong',
    projection: 5,
    source: 'https://www.fragrantica.com/perfume/Viktor-Rolf/Spicebomb-Extreme-30499.html',
    notesFlat: true,
  },
  {
    id: 'tom-ford-oud',
    ...
    season: ['Fall', 'Winter'],
    topNotes: [],
    heartNotes: ['Agarwood (Oud)', 'Brazilian Rosewood', 'Cardamom', 'Sandalwood', 'Sichuan Pepper', 'Vanilla', 'Vetiver', 'Tonka Bean', 'Amber'],
    baseNotes: [],
    ...
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Oud-Wood-1826.html',
    notesFlat: true,
  },
  {
    id: 'prada-lhomme',
  ...
  },
  {
    ...
    sillage: 'Very Strong',
    projection: 5,
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Tobacco-Vanille-1825.html',
    ingredients: [
      'Alcohol Denat.', 'Tetramethyl Acetyloctahydronaphthalenes', 'Water Aqua Eau', 'Fragrance (parfum)',
      'Vanillin', 'Linalool', 'Benzyl Benzoate', 'Geraniol', 'Limonene', 'Coumarin', 'Citronellol',
      'Eugenol', 'Isoeugenol', 'Benzyl Alcohol', 'Citral', 'Cinnamal', 'Eugenia Caryophyllus Oil',
      'Citrus Aurantium Peel Oil', 'Rose Ketones', 'Cinnamomum Zeylanicum Bark Oil', 'Geranyl Acetate',
      'Anethole', 'Pinene', 'Beta-caryophyllene', 'Eugenyl Acetate', 'Camphor', 'Terpineol',
      'Terpinolene',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/tobacco-vanille-eau-de-parfum',
  },
  {
  ...
  },
  {
    ...
    projection: 5,
    line: 'Le Male',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Ultra-Male-30947.html',
    ingredients: [
      'Alcohol Denat.', 'Aqua (Water)', 'Parfum (Fragrance)', 'Linalool', 'Hydroxycitronellal',
  ...
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter', 'Spring'],
    topNotes: ['Heliotrope', 'Cumin', 'Bergamot', 'Pink Pepper'],
    heartNotes: ['Bitter Almond', 'Lavender', 'Jasmine'],
    baseNotes: ['Vanilla', 'Sandalwood', 'Amber', 'Musk', 'Cedar'],
  ...
  },
  {
    ...
    projection: 4,
    line: 'Dylan Blue',
    source: 'https://www.fragrantica.com/perfume/Versace/Versace-Pour-Homme-Dylan-Blue-40031.html',
  },
  {
  ...
  {
    id: 'michael-malul-citizen-jack-absolute',
    name: 'Citizen Jack Absolute',
    house: 'Michael Malul London',
    audience: 'Masculine',
    price: 120,
    concentration: 'EDP',
    family: ['Fresh', 'Amber'],
    occasion: ['Everyday', 'Date Night'],
    season: ['Spring', 'Summer', 'Fall'],
    topNotes: ['Melon', 'Bergamot'],
    heartNotes: ['Pineapple', 'Amber'],
    baseNotes: ['Vanilla', 'Musk', 'Patchouli'],
    rationale: "Michael Malul's breakout hit — a tropical, fruity-sweet gourmand that punches well above its price point. Melon and pineapple ride a warm vanilla-amber base in a formula often compared to Xerjoff Erba Pura. Consistently earns compliments and is one of the safest blind buys in accessible niche.",
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  ...
  {
    id: 'michael-malul-citizen-jack-parfum',
    name: 'Citizen Jack Parfum',
    house: 'Michael Malul London',
    audience: 'Masculine',
    price: 130,
    concentration: 'Parfum',
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Fall', 'Winter'],
    topNotes: ['Melon', 'Bergamot', 'Water Lily', 'Mandarin Leaf'],
    heartNotes: ['Vanilla', 'Amberwood', 'Clary Sage', 'Violet Leaf'],
    baseNotes: ['Sandalwood', 'Tonka Bean', 'Vetiver', 'Musk'],
    rationale: "The refined, warmer evolution of Citizen Jack Absolute — violet and clary sage replace the pineapple brightness, and a sandalwood-tonka-vetiver base gives it genuine depth. Perfumer Clément Gavarry steers it into fall-winter territory that feels significantly more luxurious than its price suggests.",
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  ...
  {
    id: 'michael-malul-editor-in-chief',
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Clove', 'Cinnamon', 'Apple'],
    heartNotes: ['Cashmere Wood', 'Patchouli', 'Labdanum', 'Vetiver', 'Orris'],
    baseNotes: ['Birch', 'Cedarwood', 'Sandalwood', 'Tonka Bean', 'Vanilla'],
    rationale: "From the Esquire Collection — clove and cinnamon open with authority before settling into a rich, shifting base of patchouli, labdanum, and orris. Frequently compared to Amouage Interlude Man and Parfums de Marly Layton at a fraction of the price. Perfumer Richard Herpin makes this the most complex and rewarding fragrance in the Malul lineup.",
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  {
    id: 'michael-malul-american-novelist',
    name: 'American Novelist',
    house: 'Michael Malul London',
    audience: 'Masculine',
    price: 100,
    concentration: 'EDP',
    ...
    occasion: ['Office', 'Everyday', 'Date Night'],
    season: ['Fall', 'Winter', 'Spring'],
    topNotes: ['Mint', 'Bergamot', 'Juniper'],
    heartNotes: ['Leather', 'Clary Sage', 'Basil'],
    baseNotes: ['Moss', 'Pine', 'Cedarwood'],
    rationale: "Also from the Esquire Collection — a modern aromatic-leather that opens fresh with mint and juniper then dries into a cedar-leather-moss base frequently compared to Dior Fahrenheit but taken in a fresher, more accessible direction. Perfumers Alexis Grugeon and Honorine Blanc deliver genuine complexity for the price. A strong year-round office and evening option.",
    intensity: 3,
    longevity: '7-9 hrs',
    sillage: 'Moderate',
    projection: 3,
  ...
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Nutmeg Flower', 'Lavender', 'Cedar', 'Mandarin Orange', 'Chamomile', 'Bergamot', 'Hawthorn', 'Lemon'],
    ...
    projection: 4,
    line: 'Fahrenheit',
    source: 'https://www.fragrantica.com/perfume/Dior/Fahrenheit-228.html',
  },
  {
    id: 'aramis-classic',
    name: 'Aramis',
  ...
  },
  {
    ...
    projection: 4,
    line: 'Le Male',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Male-430.html',
    ingredients: [
      'Alcohol Denat.', 'Aqua (Water)', 'Parfum (Fragrance)', 'Hexamethylindanopyran',
      'Tetramethyl Acetyloctahydronaphthalenes', 'Coumarin', 'Linalyl Acetate', 'Linalool',
      'Vanillin', 'Alpha-Isomethyl Ionone', 'Butyl Methoxydibenzoylmethane',
      'Lavandula Oil/Extract', 'Citrus Aurantium Bergamia (Bergamot) Peel Oil', 'Limonene',
      'Cinnamomum Zeylanicum Bark Oil', 'Anise Alcohol', 'Cinnamal', 'Rose Flower Oil/Extract',
      'Hydroxycitronellal', 'Mentha Viridis (Spearmint) Leaf Oil', 'Camphor', 'Citral',
      'Carvone', 'Geranyl Acetate', 'Eugenol', 'Citrus Aurantium Peel Oil', 'Pinene',
      'Terpineol', 'Citronellol', 'Geraniol', 'Beta-Caryophyllene',
      'Dimethyl Phenethyl Acetate',
    ],
    ingredientsSource: 'https://www.sephora.com/product/mini-cologne-replica-sampler-set-P522528',
  },
  {
  ...
  },
  {
    ...
    projection: 5,
    line: 'Le Male',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Male-Le-Parfum-61856.html',
    ingredients: [
      'Alcohol Denat.', 'Parfum (Fragrance)', 'Aqua (Water)', 'Coumarin', 'Linalool',
  ...
  // ── NICHE & PRESTIGE ─────────────────────────────────────────────────────
  {
    ...
    baseNotes: ['Praline', 'Musk', 'Ambroxan', 'Tonka', 'Guaiac Wood', 'Candied Almond'],
  ...
  },
  {
    ...
    baseNotes: ['Honey', 'Tobacco', 'Tonka Bean'],
    ...
    projection: 5,
    line: 'Le Male',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Male-Elixir-81642.html',
    ingredients: [
      'Alcohol Denat.', 'Parfum (Fragrance)', 'Aqua (Water)', 'Linalool', 'Coumarin',
      'Limonene', 'Butyl Methoxydibenzoylmethane', 'Alpha-Isomethyl Ionone', 'Cinnamal',
      'Citral', 'Geraniol', 'Benzyl Benzoate', 'Benzyl Alcohol',
    ],
    ingredientsSource: 'https://www.sephora.com/product/jean-paul-gaultier-le-male-elixir-P510806',
  },
  {
    id: 'jpg-le-beau',
    name: 'Le Beau',
    ...
    projection: 4,
    line: 'Le Beau',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Beau-55785.html',
  },
  {
...

  {
    ...
    sillage: 'Strong',
    projection: 4,
    line: 'Scandal Pour Homme',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Scandal-Pour-Homme-68074.html',
  },
  ...
  // ─── Viktor & Rolf ────────────────────────────────────────────────────────
  {
    ...
    heartNotes: ['Cinnamon', 'Paprika', 'Saffron'],
    ...
    sillage: 'Moderate',
    projection: 3,
    source: 'https://www.fragrantica.com/perfume/Viktor-Rolf/Spicebomb-13857.html',
  },
  {
    id: 'vr-flowerbomb',
    name: 'Flowerbomb',
  ...
  // ---- TOM FORD: Private Blend ----
  {
    ...
    projection: 5,
    concentration: 'EDP',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Tuscan-Leather-1849.html',
    ingredients: [
      'Alcohol Denat.', 'Fragrance (parfum)', 'Water Aqua Eau', 'Hexamethylindanopyran',
      'Linalool', 'Limonene', 'Methyl 2-octynoate', 'Vanillin', 'Linalyl Acetate', 'Sclareol',
      'Pinene', 'Hexadecanolactone', 'Rose Ketones', 'Beta-caryophyllene', 'Alpha Terpinene',
      'Terpineol', 'Tetramethyl Acetyloctahydronaphthalenes',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/tuscan-leather-eau-de-parfum',
  },
  {
    ...
    projection: 4,
    concentration: 'EDP',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Fabulous-46513.html',
    ingredients: [
      'Alcohol Denat.', 'Fragrance (parfum)', 'Water Aqua Eau', 'Tetramethyl Acetyloctahydronaphthalenes',
      'Limonene', 'Linalool', 'Coumarin', 'Alpha-isomethyl Ionone', 'Hexyl Cinnamal', 'Citronellol',
      'Geraniol', 'Benzyl Benzoate', 'Farnesol', 'Citral', 'Cinnamyl Alcohol', 'Pinene',
      'Pogostemon Cablin (patchouli) Oil', 'Acetyl Cedrene', 'Citrus Aurantium Peel Oil',
      'Lavandula Oil/extract', 'Terpineol', 'Linalyl Acetate', 'Citrus Aurantium Bergamia (bergamot) Peel Oil',
      'Dimethyl Phenethyl Acetate', 'Citrus Aurantium Flower Oil', 'Beta-caryophyllene',
      'Camphor', 'Geranyl Acetate', 'Terpinolene', 'Vanillin', 'Alpha Terpinene', 'Sclareol',
      'Isoeugenyl Acetate',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/fucking-fabulous-eau-de-parfum',
  },
  {
  ...
  },
  {
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Saffron'],
    heartNotes: ['Black Rose', 'Truffle', 'Floral Notes'],
    baseNotes: ['Patchouli', 'Vanilla', 'Agarwood (Oud)', 'Oakmoss'],
    ...
    projection: 5,
    concentration: 'EDP',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Noir-de-Noir-1822.html',
    ingredients: [
      'Alcohol Denat.', 'Fragrance (Parfum)', 'Water Aqua Eau', 'Hexamethylindanopyran',
      'Pogostemon Cablin (Patchouli) Oil', 'Linalool', 'Benzyl Benzoate', 'Geraniol', 'Limonene',
      'Cinnamyl Alcohol', 'Citronellol', 'Eugenol', 'Citral', 'Vanillin', 'Farnesol', 'Beta-Caryophyllene',
      'Rose Flower Oil/Extract', 'Pinene', 'Rose Ketones', 'Camphor', 'Pelargonium Graveolens Flower Oil',
      'Geranyl Acetate', 'Terpineol', 'Terpinolene', 'Benzyl Alcohol',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/noir-de-noir-eau-de-parfum',
  },
  {
    ...
    baseNotes: ['Vanilla', 'Tonka Bean', 'Cinnamon', 'Peru Balsam', 'Benzoin', 'Sandalwood', 'Clove', 'Cedar', 'Patchouli', 'Vetiver'],
    ...
    concentration: 'EDP',
    line: 'Lost Cherry',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Lost-Cherry-51411.html',
    ingredients: [
      'Alcohol Denat.', 'Water Aqua Eau', 'Fragrance (parfum)', 'Tetramethyl Acetyloctahydronaphthalenes',
      'Vanillin', 'Rose Flower Oil/extract', 'Myroxylon Pereirae Oil/extract', 'Linalool',
      'Benzyl Benzoate', 'Coumarin', 'Eugenol', 'Isoeugenol', 'Benzyl Alcohol', 'Citral',
      'Anise Alcohol', 'Benzyl Cinnamate', 'Rose Ketones', 'Benzaldehyde', 'Trimethylcyclopentenyl Methylisopentenol',
      'Citronellol',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/lost-cherry-eau-de-parfum',
  },
  {
  ...
  },
  {
    ...
    occasion: ['Everyday', 'Date Night'],
    season: ['Fall', 'Winter'],
    topNotes: ['Cardamom', 'Akigalawood', 'Turmeric'],
    heartNotes: ['Frankincense', 'Oak', 'Cedar', 'White Sandalwood', 'Iris'],
    ...
    projection: 4,
    concentration: 'EDP',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Bois-Pacifique-100411.html',
    ingredients: [
      'Alcohol Denat.', 'Water Aqua Eau', 'Fragrance (parfum)', 'Tetramethyl Acetyloctahydronaphthalenes',
      'Alpha-isomethyl Ionone', 'Benzyl Benzoate', 'Benzyl Cinnamate', 'Citral', 'Eugenol',
      'Evernia Prunastri (oakmoss) Extract', 'Geraniol', 'Limonene', 'Linalool', 'Acetyl Cedrene',
      'Citrus Aurantium Bergamia (bergamot) Peel Oil', 'Pinene', 'Pogostemon Cablin (patchouli) Oil',
      'Linalyl Acetate', 'Vanillin', 'Beta-caryophyllene', 'Santalum Album (sandalwood) Oil',
      'Santalol', 'Geranyl Acetate', 'Terpinolene', 'Camphor', 'Terpineol', 'Eugenia Caryophyllus Oil',
      'Alpha Terpinene', 'Hexadecanolactone', 'Cinnamal', 'Ethylhexyl Methoxycinnamate',
      'Butyl Methoxydibenzoylmethane', 'Ethylhexyl Salicylate', 'Ext. Violet 2 (ci 60730)',
      'Red 4 (ci 14700)', 'Yellow 5 (ci 19140)',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/bois-pacifique-eau-de-parfum',
  },
  {
  ...
  // ---- TOM FORD: Signature ----
  {
    ...
    concentration: 'EDP',
    line: 'Ombré Leather',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Ombre-Leather-2018-50239.html',
  },
  {
    id: 'tom-ford-noir',
    name: 'Noir',
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Violet', 'Pink Pepper', 'Caraway', 'Bergamot', 'Verbena'],
    heartNotes: ['Tuscan Iris', 'Bulgarian Rose', 'Black Pepper', 'Nutmeg', 'Geranium', 'Clary Sage'],
    baseNotes: ['Indonesian Patchouli Leaf', 'Amber', 'Vanilla', 'Civet', 'Leather', 'Opoponax', 'Benzoin', 'Vetiver', 'Styrax'],
  ...
  },
  {
    ...
    heartNotes: ['Kulfi', 'Rose', 'Mastic or Lentisque', 'Orange Blossom', 'Jasmine'],
    ...
    concentration: 'EDP',
    line: 'Noir Extreme',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Noir-Extreme-29675.html',
    ingredients: [
      'Alcohol Denat.', 'Water Aqua Eau', 'Fragrance (parfum)', 'Tetramethyl Acetyloctahydronaphthalenes',
      'Benzyl Salicylate', 'Hydroxycitronellal', 'Alpha-isomethyl Ionone', 'Coumarin', 'Limonene',
      'Linalool', 'Eugenol', 'Farnesol', 'Cinnamal', 'Citronellol', 'Geraniol', 'Benzyl Benzoate',
      'Cinnamyl Alcohol', 'Vanillin', 'Linalyl Acetate', 'Hexadecanolactone', 'Pinene', 'Citrus Aurantium Peel Oil',
      'Beta-caryophyllene', 'Turpentine', 'Santalol', 'Eugenia Caryophyllus Oil', 'Pogostemon Cablin (patchouli) Oil',
      'Rose Flower Oil/extract', 'Rose Ketones', 'Benzaldehyde', 'Cananga Odorata Oil/extract',
      'Citrus Aurantium Flower Oil', 'Geranyl Acetate', 'Terpineol', 'Anethole', 'Myroxylon Pereirae Oil/extract',
      'Terpinolene', 'Alpha Terpinene', 'Phenoxyethanol',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/noir-extreme-eau-de-parfum',
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Cardamom', 'Ginger', 'Mandarin Orange', 'Neroli', 'Citrus'],
    heartNotes: ['Kulfi', 'Bulgarian Rose', 'Orange Blossom', 'Jasmine'],
    baseNotes: ['Vanilla', 'Leather', 'Suede', 'Tonka Bean', 'Amber', 'Guaiac Wood', 'Cedar'],
    ...
    concentration: 'Parfum',
    line: 'Noir Extreme',
    source: 'https://www.fragrantica.com/perfume/Tom-Ford/Noir-Extreme-Parfum-75489.html',
    ingredients: [
      'Alcohol Denat.', 'Fragrance (parfum)', 'Water Aqua Eau', 'Tetramethyl Acetyloctahydronaphthalenes',
      'Hexamethylindanopyran', 'Benzyl Salicylate', 'Hydroxycitronellal', 'Alpha-isomethyl Ionone',
      'Coumarin', 'Limonene', 'Linalool', 'Eugenol', 'Farnesol', 'Cinnamal', 'Geraniol',
      'Citronellol', 'Benzyl Benzoate', 'Amyl Cinnamal', 'Cinnamyl Alcohol', 'Citral', 'Vanillin',
      'Linalyl Acetate', 'Hexadecanolactone', 'Pinene', 'Turpentine', 'Citrus Aurantium Peel Oil',
      'Beta-caryophyllene', 'Santalol', 'Pogostemon Cablin (patchouli) Oil', 'Trimethylbenzenepropanol',
      'Eugenia Caryophyllus Oil', 'Rose Ketones', 'Rose Flower Oil/extract', 'Benzaldehyde',
      'Geranyl Acetate', 'Terpineol', 'Citrus Aurantium Flower Oil', 'Cananga Odorata Oil/extract',
      'Terpinolene', 'Anethole', 'Alpha Terpinene', 'Trimethylcyclopentenyl Methylisopentenol',
      'Amyl Salicylate', 'Phenoxyethanol',
    ],
    ingredientsSource: 'https://www.tomfordbeauty.com/products/noir-extreme-parfum',
  },
  ...
  // ---- VERSACE ----
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Mint', 'Lemon', 'Black Pepper', 'Elemi', 'Litsea Cubeba'],
    heartNotes: ['Green Apple', 'Geranium', 'Lavender', 'Sage', 'Pomarose'],
    baseNotes: ['Tonka Bean', 'Amber', 'Vanilla', 'Patchouli', 'Benzoin'],
    ...
    concentration: 'Parfum',
    line: 'Eros',
    source: 'https://www.fragrantica.com/perfume/Versace/Eros-Parfum-70090.html',
    ingredients: [
      'Alcohol Denat. (Sd Alcohol 39-C .)', 'Parfum (Fragrance)', 'Aqua (Water)', 'Limonene',
      'Coumarin', 'Linalool', 'Alpha-Isomethyl Ionone', 'Citral', 'Citronellol', 'Geraniol',
      'Cinnamal', 'Eugenol',
    ],
    ingredientsSource: 'https://www.ulta.com/p/eros-parfum-pimprod2029391',
  },
  {
    ...
    heartNotes: ['Geranium', 'Rose', 'Pepperwood'],
    ...
    line: 'Eros',
    concentration: 'EDP',
    source: 'https://www.fragrantica.com/perfume/Versace/Eros-Flame-52180.html',
    ingredients: [
      'Alcohol Denat. (Sd Alcohol 39-C)', 'Fragrance', 'Water', 'Limonene', 'Linalool', 'Coumarin',
      'Ethylhexyl Methoxycinnamate', 'Alpha-Isomethyl Ionone', 'Citronellol', 'Citral', 'Ethylhexyl Salicylate',
      'Butyl Methoxydibenzoylmethane', 'Geraniol', 'Isoeugenol',
    ],
    ingredientsSource: 'https://www.ulta.com/p/eros-flame-eau-de-parfum-pimprod2004721',
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Caramel', 'Italian Mandarin'],
    heartNotes: ['Cardamom', 'Oud'],
  ...
  },
  {
    ...
    occasion: ['Everyday', 'Date Night'],
    season: ['Fall', 'Winter'],
    topNotes: ['Chestnut', 'Sugar'],
    heartNotes: ['Sage', 'Lavender'],
    baseNotes: ['Vanilla', 'Smoke'],
    ...
    projection: 3,
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-45258.html',
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau', 'Limonene', 'Linalool',
      'Coumarin', 'Diethylamino Hydroxybenzoyl Hexyl Benzoate', 'Isoeugenol', 'Citronellol',
      'Alpha-Isomethyl Ionone', 'Eugenol', 'Citral', 'Benzyl Alcohol', 'Geraniol', 'Cinnamal',
      'Methyl 2-Octynoate', 'CI 19140 / Yellow 5', 'CI 14700 / Red 4',
      'CI 60730 / Ext. Violet 2',
    ],
    ingredientsSource: 'https://www.ulta.com/p/emporio-armani-stronger-with-you-eau-de-toilette-xlsImpprod16711001',
    formulaCode: 'F.I.L. B266362/1',
  },
  {
    ...
    concentration: 'EDP',
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Absolutely-64501.html',
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau', 'Butyl Methoxydibenzoylmethane',
      'Coumarin', 'Linalool', 'Isoeugenol', 'Limonene', 'Alpha-Isomethyl Ionone', 'Eugenol',
      'Citronellol', 'Cinnamal', 'Benzyl Alcohol', 'Geraniol', 'Citral', 'CI 14700 / Red 4',
      'CI 15510 / Orange 4', 'Methyl 2-Octynoate', 'CI 60730 / Ext. Violet 2',
    ],
    ingredientsSource: 'https://www.giorgioarmanibeauty-usa.com/fragrances/mens-cologne/stronger-with-you-absolutely-parfum/ww-00424-arm.html',
    formulaCode: 'F.I.L. N70035952/1',
  },
  {
    ...
    baseNotes: ['Vanilla', 'Leather', 'Guaiac Wood', 'Agarwood (Oud)'],
    ...
    concentration: 'EDP',
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Leather-63355.html',
    status: 'regional',
    includeReason: 'Middle East special edition (2020) already in the catalog before the inclusion rule; kept rather than retired because its id is published and may hold stored user data.',
  },
  {
    ...
    rationale: "The line's chestnut and vanilla at parfum strength, edged with leather: drier and more grown-up than Intensely.",
    intensity: 4,
    longevity: '10-12 hrs',
    sillage: 'Strong',
    projection: 4,
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Parfum-100895.html',
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau', 'Coumarin', 'Linalool',
      'Limonene', 'Isoeugenol', 'Citronellol', 'Alpha-Isomethyl Ionone', 'Eugenol',
      'Benzyl Alcohol', 'Citral', 'Geraniol', 'Cinnamal', 'Cinnamyl Alcohol',
      'Benzyl Benzoate', 'Methyl 2-Octynoate',
    ],
    ingredientsSource: 'https://www.giorgioarmanibeauty-usa.com/fragrances/mens-cologne/stronger-with-you-parfum/ww-00911-arm.html',
    formulaCode: 'F.I.L. N70048180/3',
  },
  {
    ...
    occasion: ['Date Night'],
    season: ['Fall', 'Winter'],
    topNotes: ['Cherry', 'Mandarin Orange'],
    heartNotes: ['Spices', 'Lavender'],
    baseNotes: ['Chestnut', 'Vanilla', 'Amberwood'],
    rationale: 'Cherry and mandarin over smoky chestnut and vanilla: the sweetest, loudest take on the line.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Powerfully-123070.html',
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau',
      'Tetramethyl Acetyloctahydronaphthalenes', 'Coumarin', 'Vanillin',
      'Juniperus Virginiana Oil', 'Butyl Methoxydibenzoylmethane', 'Acetyl Cedrene', 'Carvone',
      'Limonene', 'Isoeugenyl Acetate', 'Isoeugenol', 'Citrus Limon Peel Oil',
      'Linalyl Acetate', 'Benzyl Benzoate', 'Linalool', 'Eugenol', 'Pinene',
      'Lavandula Oil/Extract', 'Beta-Caryophyllene', 'Rose Ketones', 'Benzyl Alcohol',
      'Cinnamomum Zeylanicum Bark Oil', 'Trimethylcyclopentenyl Methylisopentenol', 'Cinnamal',
      'Citrus Aurantium Peel Oil', 'Citrus Aurantium Bergamia Peel Oil', 'Methyl Anthranilate',
    ],
    ingredientsSource: 'https://www.ulta.com/p/giorgio-armani-stronger-with-you-powerfully-eau-de-parfum-pimprod2057857?sku=2653815',
  },
  {
    ...
    season: ['Fall', 'Winter'],
    topNotes: [],
    heartNotes: ['Amber', 'Madagascar Vanilla', 'Lavender'],
    baseNotes: [],
    rationale: 'A softer amber, lavender and vanilla take on the line; the quietest of the flankers.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Amber-79699.html',
    notesFlat: true,
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau', 'Ethylhexyl Salicylate',
      'Butyl Methoxydibenzoylmethane', 'Coumarin', 'Citronellol', 'Linalool', 'Isoeugenol',
      'Limonene', 'Benzyl Benzoate', 'Eugenol', 'Geraniol', 'Alpha-Isomethyl Ionone',
      'Benzyl Cinnamate', 'Cinnamal', 'Benzyl Alcohol',
      'Tris(tetramethylhydroxypiperidinol) Citrate', 'Citral',
    ],
    ingredientsSource: 'https://www.giorgioarmanibeauty-usa.com/fragrances/stronger-with-you-eau-de-parfum-amber/ww-01014-arm.html',
  },
  {
    id: 'stronger-with-you-sandalwood',
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Saffron'],
    heartNotes: ['Lavender', 'Chestnut'],
    baseNotes: ['Sandalwood', 'Vanilla', 'Cedarwood'],
    rationale: "Saffron and sugared chestnut settling into creamy sandalwood: the line's woodiest, least bubblegum-sweet flanker.",
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
    line: 'Stronger With You',
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Emporio-Armani-Stronger-With-You-Sandalwood-102519.html',
    status: 'regional',
    includeReason: 'Middle East exclusive (2025); included by explicit exception as the most hyped entry in the Stronger With You line.',
  },
  ...
  },
  {
    ...
    baseNotes: ['Amberwood', 'Bourbon Vanilla', 'Vetiver'],
    rationale: 'The 2021 release that reset the Wanted line — a three-note structure of cardamom, toffee and amberwood that reads far richer than its brevity suggests. Sold in a brown bottle and often labelled Eau de Parfum Intense on the box, which is the single biggest source of confusion in this range.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Red Ginger', 'Ginger'],
    heartNotes: ['Toffee', 'Woody Notes'],
    baseNotes: ['Bourbon Vanilla', 'Tonka Bean'],
    rationale: 'The matte-black flanker and the sweetest point of the line. Fiery red ginger gives way to toffee and Madagascan bourbon vanilla — closer to a gourmand than the spicy EDP, and the one most often compared to Stronger With You Intensely.',
    intensity: 5,
    longevity: '8-10 hrs',
    sillage: 'Very Strong',
    projection: 4,
  },
  {
    ...
    topNotes: ['Bergamot'],
    heartNotes: ['Lavender'],
    baseNotes: ['Liquor', 'Oakmoss'],
    rationale: 'The odd one out, and the reason the name is misleading: despite Intense on the bottle this is the freshest thing in the range. Bergamot into a linear sweet lavender over moss, with a liquor accord that reviewers struggle to detect. Widely compared to YSL MYSLF.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  ...
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Raspberry', 'Green Mandarin', 'Bergamot'],
    heartNotes: ['Cardamom', 'Lavender', 'Clary Sage'],
    baseNotes: ['Leather', 'Wolfwood', 'Vetiver'],
    rationale: 'The 2025 gold-bottle entry and the line at its most concentrated. Juicy raspberry against a genuine leather accord — a sharper, fruitier direction than the toffee flankers, though several reviewers find it lands close to Wanted by Night.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Whiskey', 'Incense'],
    heartNotes: ['Incense', 'Amber Woods'],
    baseNotes: ['Vanilla', 'Amber Woods'],
    rationale: 'The newest and least documented of the line — an incense-and-whiskey amber that early wearers describe as a salted butterscotch opening resolving into a long incense-vanilla drydown. Note structure here is drawn from brand copy rather than a published pyramid.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  // ---- DIOR ----
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Bergamot', 'Mandarin Orange', 'Elemi'],
    ...
    concentration: 'Parfum',
    line: 'Sauvage',
    source: 'https://www.fragrantica.com/perfume/Dior/Sauvage-Parfum-56324.html',
  },
  {
    id: 'dior-homme-sport',
  ...
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Lavender', 'Ambroxan', 'Bergamot'],
    heartNotes: ['Vietnamese Oud'],
    baseNotes: ['Virginia Cedar', 'Atlas Cedar', 'Vetiver', 'Patchouli'],
    rationale: "Francis Kurkdjian's 2026 top of the Sauvage ladder — the familiar lavender-ambroxan opening turned dark and smoky over a Vietnamese oud heart and dry cedars. Drier and woodier than Elixir, with none of its sweet spice.",
    intensity: 5,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Dior/Sauvage-Extrait-138704.html',
  },
  ...
  // ── DUMONT ────────────────────────────────────────────────────────────────
  {
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Spring', 'Fall', 'Winter'],
    topNotes: ['Bergamot', 'Cardamom', 'Apple', 'Orange'],
    heartNotes: ['Orange Blossom', 'Praline', 'Geranium', 'Mint'],
    baseNotes: ['Ambergris', 'Tonka Bean', 'Amber', 'Moss'],
    rationale: 'A 2025 viral hit drawing comparisons to YSL Myself — sweet praline and mint drying down to warm ambergris and amber. Extrait concentration punches well above its price point with 8–12 hours of longevity.',
    intensity: 4,
    longevity: '8-12 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  // ── LATTAFA ───────────────────────────────────────────────────────────────
  {
    ...
    baseNotes: ['Vanilla', 'Tonka Bean', 'Benzoin', 'Myrrh', 'Amberwood'],
    rationale: 'The viral Arabic gourmand that introduced millions to Middle Eastern perfumery. Boozy dates, cinnamon, and praline in a rich vanilla-amberwood base — often compared to Angels Share at a fraction of the cost.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Mandarin', 'Pimento', 'Smoked Spices'],
    heartNotes: ['Incense', 'Labdanum', 'Orange Blossom', 'Patchouli'],
    baseNotes: ['Tobacco', 'Praline', 'Amber', 'Tonka Bean', 'Benzoin'],
    rationale: 'Dukhan means smoke — the darkest and most mature Khamrah flanker. Spiced mandarin and pimento give way to incense and tobacco over a praline-amber base. Beast-mode longevity with serious Middle Eastern depth.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    baseNotes: ['Coffee', 'Vanilla', 'Tonka Bean', 'Benzoin', 'Musk'],
    rationale: 'The coffee-forward sibling of Khamrah. Spiced cardamom opens to a roasted coffee-praline heart — think boozy Christmas coffee cake. One of the best-value gourmands available anywhere.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    rationale: 'Sweet boozy apple shisha meets oud smoke and caramel — rugged, masculine, and addictive. Reviewers report 12+ hour longevity and room-filling projection. Uniquely distinctive within the Lattafa lineup.',
    intensity: 5,
    longevity: '12+ hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  // ── AL HARAMAIN ───────────────────────────────────────────────────────────
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Tobacco Leaf', 'Cinnamon', 'Black Pepper', 'Ginger'],
    heartNotes: ['Vanilla', 'Clove', 'Star Anise', 'Tonka Bean', 'Cacao', 'Incense'],
    baseNotes: ['Tobacco', 'Dried Fruits', 'Woodsy Notes'],
    rationale: 'Widely regarded as one of the closest Tom Ford Tobacco Vanille alternatives — spicier and more tobacco-forward than the original. Bold cinnamon, cacao, and cloves over a smoky base. Exceptional performance for the price.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  {
    id: 'al-haramain-amber-oud-rouge',
    ...
    concentration: 'EDP',
    family: ['Amber', 'Floral'],
    occasion: ['Date Night', 'Everyday', 'Formal'],
    season: ['Spring', 'Fall', 'Winter'],
    topNotes: ['Jasmine', 'Saffron'],
    heartNotes: ['Amberwood', 'Ambergris', 'Cedar'],
    baseNotes: ['Fir Resin', 'Musk'],
    rationale: 'Al Haramains take on the Baccarat Rouge 540 DNA — sweet jasmine-saffron over an amberwood-cedar base. Widely praised as one of the best-value BR540 alternatives with surprisingly close performance and longevity.',
    intensity: 4,
    longevity: '10-12 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  // ── AFNAN ─────────────────────────────────────────────────────────────────
  {
    ...
    rationale: 'The crowd-pleasing Arabic alternative to JPG Ultra Male — sweet apple, lavender, and creamy vanilla with a patchouli base. A universal compliment magnet and one of the best entry points into Arabian perfumery.',
    intensity: 4,
    longevity: '6-8 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  },
  {
    ...
    rationale: 'A darker spicier evolution of 9PM — cardamom and nutmeg over leather and lavender with a rich vanilla-labdanum base. Draws comparisons to Le Male Elixir and Khamrah Dukhan. Strong beast-mode performance.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  // ---- Designer additions ----
  {
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Lavender'],
    heartNotes: ['Vanilla Absolute', 'Vanilla Caviar'],
    baseNotes: ['Ginger', 'Cocoa'],
    rationale: 'A three-vanilla study — absolute, caviar and infusion — cut with lavender so it reads warm rather than sugary. The vanilla release that defined the category for a generation of wearers.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Bergamot', 'Nutmeg', 'Cinnamon'],
    heartNotes: ['Lavender', 'Blue Ginger'],
    baseNotes: ['Vanilla', 'Cedarwood', 'Tonka Bean'],
    rationale: 'The richest tier of the Cobalt line — spiced bergamot and blue ginger folded into a thick vanilla-tonka base. Sweeter and more enveloping than Cobalt EDP, built for cold-weather evenings.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Fall', 'Winter'],
    topNotes: ['Red Currant', 'Pomegranate'],
    heartNotes: ['Rose', 'Peony'],
    baseNotes: ['Vanilla', 'Sandalwood'],
    rationale: 'The red-lipstick sibling to Good Girl — tart red currant and pomegranate over a rose-peony heart, landing on creamy vanilla-sandalwood. Brighter and more playful than the original.',
    intensity: 4,
    longevity: '7-9 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Formal', 'Date Night'],
    season: ['Spring', 'Fall'],
    topNotes: ['Grapefruit', 'Bergamot', 'Cardamom'],
    heartNotes: ['Rose', 'Iris', 'Osmanthus'],
    baseNotes: ['Sandalwood', 'Musk', 'Vanilla'],
    rationale: 'Creed\'s tribute to the Silk Road — a plush rose-iris centre wrapped in osmanthus and sandalwood. One of the house\'s more refined feminine compositions and a departure from its citrus-forward reputation.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    heartNotes: ['Leather', 'Violet', 'Incense'],
    baseNotes: ['Vetiver', 'Cedar', 'Amber'],
    rationale: 'The concentrated take on Fahrenheit — the divisive petrol-violet accord dialled back in favour of dark leather and incense. Smoother and more wearable than the EDT for anyone who found the original abrasive.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 4,
  },
  {
    ...
    season: ['Fall', 'Winter'],
    topNotes: [],
    heartNotes: ['Tobacco', 'Tobacco Leaf', 'Honey', 'Smoke', 'Plum', 'Amber', 'Oriental notes', 'White Tobacco', 'Peach', 'Citrus'],
    baseNotes: [],
    rationale: 'From La Collection Privée — a golden, honeyed tobacco built on saffron and warm spice rather than smoke. Rich without being heavy, and one of the more approachable entries in the Privée range.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Dior/Tobacolor-65551.html',
    notesFlat: true,
    ingredients: [
      'Alcohol', 'Parfum (Fragrance)', 'Dipropylene Glycol', 'Aqua (Water)',
      'Butyl Methoxydibenzoylmethane', 'Coumarin', 'Limonene', 'Eugenol', 'Benzyl Benzoate',
      'Benzyl Cinnamate', 'Tris(Tetramethylhydroxypiperidinol) Citrate', 'Benzyl Alcohol',
      'CI 47005 (Yellow 10)', 'Linalool', 'CI 17200 (Red 33)',
    ],
    ingredientsSource: 'https://www.dior.com/en_id/beauty/products/tobacolor-Y0996186.html',
    formulaCode: '#20566',
  },
  {
    id: 'dior-homme-edp-2020',
    name: 'Dior Homme',
    house: 'Dior',
    audience: 'Masculine',
    price: 145,
    ...
    season: ['Fall', 'Winter', 'Spring'],
    topNotes: ['Bergamot', 'Pink Pepper'],
    heartNotes: ['Iris', 'Cashmere Wood'],
    baseNotes: ['Patchouli', 'White Musk', 'Amber'],
    rationale: 'The 2020 reformulation that reset the pillar — Francois Demachy stripped out the cocoa and lipstick facets for a cleaner, woodier iris. Distinct enough from the Intense and the EDT to warrant its own place.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    baseNotes: ['Patchouli', 'Vetiver', 'Ambrette'],
    rationale: 'The lightest expression of the modern L\'Interdit — white florals over a clean patchouli-vetiver base, with pear and neroli keeping the tuberose from turning heavy. The daytime option in the line.',
    intensity: 3,
    longevity: '5-7 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    heartNotes: ['Vanilla'],
    baseNotes: ['Tonka'],
    rationale: 'The intense reading of La Belle — the pear and vanilla pushed into full gourmand territory with tonka and sandalwood adding weight. Considerably richer and longer-lasting than the EDP.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/La-Belle-Le-Parfum-2024-93892.html',
  },
  {
    id: 'jpg-la-belle-paradise-garden',
    ...
    heartNotes: ['Iris'],
    baseNotes: ['Vanilla'],
    rationale: 'The tropical flanker — pineapple and coconut layered onto the La Belle vanilla spine for a beachy, sunscreen-adjacent sweetness. The warm-weather counterpart to the original.',
    intensity: 4,
    longevity: '7-9 hrs',
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/La-Belle-Paradise-Garden-88873.html',
  },
  {
    id: 'jpg-le-beau-narcisse',
    ...
    baseNotes: ['Vanilla', 'Tonka Bean', 'Vetiver'],
    rationale: 'A greener, more introspective Le Beau — narcissus and vetiver pulling the coconut-tonka base toward something earthier. Less crowd-pleasing than the EDT and more interesting for it.',
    intensity: 4,
    longevity: '7-9 hrs',
    sillage: 'Moderate',
    projection: 3,
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Beau-Narcisse-122215.html',
  },
  {
    id: 'paco-invictus-parfum',
    ...
    heartNotes: ['Cedarwood', 'Sage'],
    baseNotes: ['Amberwood', 'Vanilla', 'Tonka Bean'],
    rationale: 'The darkest tier of the Invictus ladder — the marine freshness of the EDT swapped for cedar, amberwood and vanilla. Almost unrecognisable next to the original, and better for cold weather.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Nutmeg', 'Green Apple', 'Saffron'],
    heartNotes: ['Tonka Bean', 'Rose', 'Osmanthus', 'Davana'],
    baseNotes: ['Patchouli', 'Vanilla', 'Opoponax'],
    rationale: 'Spiced apple and cinnamon over a resinous patchouli-vanilla base — the most autumnal thing in the Marly lineup. Unisex but leans masculine, and consistently one of the house\'s better performers.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Spring', 'Fall'],
    topNotes: ['Litchi', 'Rhubarb', 'Bergamot'],
    heartNotes: ['Turkish Rose', 'Peony', 'Vanilla'],
    baseNotes: ['Cashmeran', 'Musk', 'Incense'],
    rationale: 'The house\'s signature feminine — litchi and rhubarb brightening a Turkish rose heart, finished with cashmeran musk. Widely imitated and still the reference point for the modern fruity-rose.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Lavender', 'Clary Sage', 'Bergamot'],
    heartNotes: ['Saffron', 'Praline'],
    baseNotes: ['Agarwood (Oud)', 'Cedar'],
    rationale: 'Lavender and clary sage over praline and oud — a fougere skeleton wearing a gourmand coat. One of the more distinctive masculine Marlys and heavily targeted by clone houses.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  },
  {
    ...
    rationale: 'Pear and white florals folded into a warm vanilla-tonka base. The cosier end of the Marly feminine range, closer to a gourmand than Delina\'s bright fruity-rose.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    baseNotes: ['Vanilla', 'Tonka Bean', 'Patchouli', 'Musk'],
    rationale: 'From the Oriental collection — boozy rum and saffron over rose and oud. The most opulent register Marly works in, and the closest the house comes to traditional Middle Eastern perfumery.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
    source: 'https://www.fragrantica.com/perfume/Parfums-de-Marly/Oajan-21548.html',
    ingredients: [
      'Alcohol Denat.', 'Parfum (Fragrance)', 'Aqua (Water)', 'Coumarin', 'Cinnamyl Alcohol',
      'Limonene', 'Linalool', 'Cinnamal', 'BHT', 'Eugenol', 'Alpha-Isomethyl Ionone', 'Citral',
      'Benzyl Benzoate',
    ],
    ingredientsSource: 'https://us.parfums-de-marly.com/products/oajan',
  },
  {
    id: 'prada-candy-edp',
    name: 'Candy',
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Caramel'],
    heartNotes: ['Benzoin', 'Musk'],
    baseNotes: ['Vanilla', 'Powdery Notes'],
    rationale: 'A caramel-benzoin gourmand with an unusual powdery finish that keeps it from reading juvenile. Minimal note list, maximal presence — the caramel does most of the work.',
    intensity: 4,
    longevity: '7-9 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    baseNotes: ['Cedarwood', 'Amber', 'Musk'],
    rationale: 'A recent Prada masculine built on iris and cedar — restrained and office-appropriate where Luna Rossa leans sporty. Distinct from Paradoxe Pour Homme despite the similar name.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  ...
  {
    id: 'emporio-armani-power-of-you',
    name: 'Power of You',
    house: 'Emporio Armani',
    audience: 'Feminine',
    price: 125,
    ...
    rationale: 'The newest addition to the Stronger With You family and the first to lead feminine — pear and white florals over the line\'s signature vanilla-praline base.',
    intensity: 4,
    longevity: '7-9 hrs',
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Giorgio-Armani/Power-Of-You-121870.html',
    ingredients: [
      'Alcohol', 'Parfum / Fragrance', 'Aqua / Water / Eau',
      'Tetramethyl Acetyloctahydronaphthalenes', 'Vanillin', 'Carvone', 'Limonene',
      'Citrus Aurantium Peel Oil', 'Linalool', 'Diethylamino Hydroxybenzoyl Hexyl Benzoate',
      'Citrus Limon Peel Oil', 'Pinene', 'Acetyl Cedrene', 'Beta-Caryophyllene',
      'Alpha-Isomethyl Ionone', 'Citral', 'Geranyl Acetate', 'Rose Ketones', 'Linalyl Acetate',
      'CI 14700 / Red 4', 'Geraniol', 'Terpineol', 'CI 60730 / Ext. Violet 2',
      'Alpha-Terpinene', 'CI 19140 / Yellow 5',
    ],
    ingredientsSource: 'https://www.sephora.co.uk/p/armani-power-of-you-eau-de-parfum',
    formulaCode: 'F.I.L. N70080880/3',
  },
  {
    ...
    occasion: ['Everyday', 'Office'],
    season: ['Spring', 'Summer'],
    topNotes: ['Lemon', 'Bergamot', 'Rosewood'],
    heartNotes: ['Cedar', 'Tarragon', 'Sage'],
    baseNotes: ['Amber', 'Musk', 'Saffron'],
    rationale: 'The blue bottle that anchored a decade of office-safe freshies — lemon and rosewood over cedar and a light amber. Modest projection but enduringly wearable and consistently well-priced.',
    intensity: 2,
    longevity: '4-6 hrs',
    sillage: 'Light',
    projection: 2,
  },
  {
    ...
    baseNotes: ['Agarwood', 'Vanilla', 'Cedar', 'Musk'],
    rationale: 'The Oud Stars flagship — citrus and orris opening onto a rich agarwood-vanilla base. Expensive, dense, and the fragrance most often cited when people argue Xerjoff justifies its pricing.',
    intensity: 5,
    longevity: '12+ hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    baseNotes: ['Vanilla', 'Cedarwood', 'Ambergris'],
    rationale: 'A lavender-orange blossom fougere marketed feminine — the structure is classically masculine and the vanilla-musk drydown is what sells it. Arguably the most unisex of the modern YSL pillars.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Bergamot', 'Pink Pepper'],
    heartNotes: ['Patchouli', 'Violet Leaf'],
    baseNotes: ['Vetiver', 'Leather', 'Amber'],
    rationale: 'From Le Vestiaire des Parfums — a dry, sharp patchouli built around the house\'s tuxedo codes. Sparse and tailored where the mainline YSL releases are crowd-facing.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    heartNotes: ['Suede', 'Leather Accord'],
    baseNotes: ['Vanilla', 'Amber', 'Musk'],
    rationale: 'Le Vestiaire\'s cult release — a soft suede-and-vanilla leather named for the house\'s handbag. Warmer and more skin-like than most leather compositions, which is why it developed the following it has.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    heartNotes: ['Cinnamon', 'Geranium', 'Incense'],
    baseNotes: ['Cedarwood', 'Patchouli', 'Amber', 'Musk'],
    rationale: 'From the Odyssey collection — spiced cardamom and incense over a dry cedar-patchouli base. More restrained than the Amouage flagships, and one of the easier entry points into the house.',
    intensity: 4,
    longevity: '10-12 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Honey', 'Cherry', 'Saffron'],
    heartNotes: ['Tobacco', 'Cinnamon', 'Nutmeg'],
    baseNotes: ['Vanilla', 'Tonka Bean', 'Cedarwood'],
    rationale: 'Honeyed tobacco with a boozy cherry lift — the reference gourmand-tobacco and the fragrance most other honey-tobacco compositions get measured against.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Everyday', 'Office'],
    season: ['Spring', 'Summer'],
    topNotes: ['Bergamot', 'Citron', 'Black Tea'],
    heartNotes: ['Ginger', 'Cardamom'],
    baseNotes: ['Ambrox', 'Guaiac Wood'],
    rationale: 'Citrus and black tea over a heavy ambrox base — a freshie with unusual longevity for the category. The most commercially successful masculine Vuitton has released.',
    intensity: 3,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    baseNotes: ['White Woods', 'Vanilla', 'Musk'],
    rationale: 'A light, powdery floral that became a generational signature — strawberry and violet leaf over gardenia. Undemanding by design and still a reliable everyday option.',
    intensity: 2,
    longevity: '4-6 hrs',
    sillage: 'Light',
    projection: 2,
  },
  {
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Fall', 'Winter'],
    topNotes: ['Green Nashi Pear', 'Cardamom'],
    heartNotes: ['Vetiver', 'Geranium'],
    baseNotes: ['Ambroxan', 'Suede', 'Cedarwood'],
    rationale: 'Pear and cardamom over ambroxan and suede — a well-blended designer that regularly outperforms its price. Frequently discounted, which is much of its appeal.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    heartNotes: ['Cinnamon', 'Jasmine'],
    baseNotes: ['Vanilla', 'Tonka Bean', 'Amber'],
    rationale: 'A fruitier, more casual reading of the 9PM formula — pineapple and apple brightening the vanilla-tonka core. Less dense than the Elixir and easier to wear in rotation.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    heartNotes: ['Rose', 'Cedarwood'],
    baseNotes: ['Oud', 'Amber', 'Musk', 'Vanilla'],
    rationale: 'The most polished entry in the Supremacy range — saffron and rose over oud and amber, presented in the house\'s heaviest packaging. Strong performance typical of the line.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    rationale: 'Saffron and raspberry over a sweet oud-amber base — one of the most recommended budget entries into Middle Eastern perfumery, and the fragrance that put Swiss Arabian on Western radar.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    rationale: 'A note-for-note tracing of Le Beau Le Parfum at a fraction of the cost — pineapple and coconut over tonka and sandalwood. Woodier and more coconut-forward than the original. Benefits from a few weeks of maceration.',
    intensity: 4,
    longevity: '6-8 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Plum', 'Cardamom', 'Cinnamon', 'Bergamot'],
    heartNotes: ['Lavender', 'Artemisia', 'Davana'],
    baseNotes: ['Tonka Bean', 'Benzoin', 'Labdanum', 'Patchouli'],
    rationale: 'Syrupy plum and warm spice over a resinous tonka-benzoin base. Not a direct clone, though it sits in the same territory as Le Male Elixir. Wearers consistently report it improving markedly after maceration.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  {
    id: 'french-avenue-miraj-absolu',
    name: 'Miraj Absolu',
    house: 'French Avenue',
    audience: 'Masculine',
    price: 60,
    concentration: 'EDP',
    inspiredBy: 'Parfums de Marly Layton Exclusif',
    family: ['Woody', 'Spicy'],
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Pink Pepper', 'Bergamot', 'Mandarin Orange'],
    heartNotes: ['Civet', 'Geranium', 'Rose', 'Gardenia', 'Water Lily'],
    baseNotes: ['Patchouli', 'Oud', 'Vanilla', 'Coffee', 'Amber', 'Oakmoss'],
    rationale: 'Widely considered the closest Layton Exclusif alternative on the market — the same fruity-floral opening over a darker, more animalic patchouli base. More synthetic than the original but louder and longer-lasting.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  // ---- Armaf: The Lions Club ----
  {
    id: 'armaf-lions-club-rugir',
    name: 'The Lions Club Rugir',
    house: 'Armaf',
    audience: 'Masculine',
    price: 40,
    concentration: 'EDP',
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Fall', 'Winter'],
    topNotes: ['Apple', 'Lavender', 'Mandarin Orange', 'Bergamot'],
    heartNotes: ['Geranium', 'Violet', 'Jasmine'],
    baseNotes: ['Vanilla', 'Guaiac Wood', 'Amber', 'Sandalwood', 'Patchouli', 'Cardamom'],
    rationale: 'Armaf\'s Layton interpretation — apple and lavender over a violet-jasmine heart landing on vanilla and guaiac. Reported as a strong performer, though reviewers rate Al Haramain\'s Detour Noir the closer match.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  {
    id: 'armaf-lions-club-feroce',
    name: 'The Lions Club Feroce',
    house: 'Armaf',
    audience: 'Masculine',
    price: 40,
    concentration: 'EDP',
    line: 'The Lions Club',
    inspiredBy: 'Parfums de Marly Haltane',
    family: ['Woody', 'Gourmand'],
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Bergamot', 'Lavender', 'Clary Sage'],
    heartNotes: ['Praline', 'Saffron'],
    baseNotes: ['Agarwood', 'Oud', 'Cedarwood', 'Vetiver'],
    rationale: 'The Haltane target — lavender and clary sage over praline and oud, tracking the original\'s structure closely. Community estimates put similarity around 90%.',
    intensity: 5,
    longevity: '8-10 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  {
    id: 'armaf-lions-club-valer',
    name: 'The Lions Club Valer',
    house: 'Armaf',
    audience: 'Masculine',
    price: 40,
    concentration: 'EDP',
    line: 'The Lions Club',
    inspiredBy: 'Parfums de Marly Sedley',
    family: ['Woody', 'Aromatic'],
    occasion: ['Everyday', 'Office'],
    season: ['Spring', 'Summer'],
    topNotes: ['Bergamot', 'Grapefruit', 'Mint', 'Mandarin Orange'],
    heartNotes: ['Rosemary', 'Frankincense', 'Lavender', 'Geranium'],
    baseNotes: ['Amber', 'Cedar', 'Sandalwood', 'Vetiver', 'Patchouli', 'Cashmeran'],
    rationale: 'The closest thing to Sedley at a tenth the price — reviewers put it at 90%+ similarity, creamier and less fizzy than the original. The strongest summer option in the collection.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  ...
  {
    id: 'armaf-lions-club-monarque',
    name: 'The Lions Club Monarque',
    house: 'Armaf',
    audience: 'Masculine',
    price: 40,
    concentration: 'EDP',
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Fall', 'Winter'],
    topNotes: ['Cinnamon', 'Orange Blossom', 'Bergamot', 'Cardamom'],
    heartNotes: ['Elemi', 'Vanilla'],
    baseNotes: ['Candied Almond', 'Guaiac Wood', 'Ambroxan', 'Praline', 'Tonka Bean', 'Musk'],
    rationale: 'The Althaïr reading — candied almond and praline over vanilla and guaiac, with orange blossom doing the lifting up top. Reported as one of the heavier performers in the line.',
    intensity: 5,
    longevity: '8-10 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  {
    id: 'armaf-lions-club-majestueux',
    name: 'The Lions Club Majestueux',
    house: 'Armaf',
    audience: 'Masculine',
    price: 40,
    concentration: 'EDP',
    ...
    heartNotes: ['Tobacco', 'Frankincense', 'Osmanthus', 'Labdanum'],
    baseNotes: ['Vanilla', 'Vetiver', 'Cedar', 'Musk', 'Cypriol'],
    rationale: 'Spiced tobacco and resins over a cypriol-vetiver base. The Godolphin mapping is inferred from the note structure rather than stated by Armaf, but the correspondence is close.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  // ---- Armaf: Club de Nuit ----
  {
    id: 'armaf-cdn-intense-man-edt',
    name: 'Club de Nuit Intense Man',
    house: 'Armaf',
    audience: 'Masculine',
    price: 35,
    concentration: 'EDT',
    line: 'Club de Nuit Intense Man',
    ...
    rationale: 'The most successful clone ever made and the reason the entire category exists. Smoky pineapple over birch, at roughly a fifteenth of Aventus. The lemon-heavy opening divides people; the drydown rarely does.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  {
    id: 'armaf-cdn-intense-man-parfum',
    ...
    heartNotes: ['Birch', 'Rose', 'Jasmine'],
    baseNotes: ['Patchouli', 'Vanilla', 'Ambergris', 'Musk'],
    rationale: 'The 2022 parfum tier — the acrid lemon opening of the EDT sanded down, with more weight in the vanilla and patchouli. Smoother and more expensive-smelling, though some prefer the original\'s bite.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  ...
  {
    id: 'armaf-cdn-intense-man-extrait',
    ...
    occasion: ['Date Night', 'Formal'],
    season: ['Fall', 'Winter'],
    topNotes: ['Pineapple', 'Lemon', 'Bergamot', 'Black Currant', 'Apple'],
    heartNotes: ['Birch', 'Rose', 'Jasmine'],
    baseNotes: ['Patchouli', 'Vanilla', 'Ambergris', 'Musk'],
    rationale: 'The 2025 extrait — much of the EDT\'s birch smoke traded for vanilla and ambergris. The furthest from Aventus of the three tiers and the most conventionally pleasant.',
    intensity: 5,
    longevity: '12+ hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    occasion: ['Everyday', 'Office'],
    season: ['Spring', 'Summer'],
    topNotes: ['Bergamot', 'Mandarin Orange', 'Green Tea'],
    heartNotes: ['Black Currant', 'Jasmine', 'Petitgrain'],
    baseNotes: ['Musk', 'Sandalwood', 'Ambergris'],
    rationale: 'Green tea and black currant over a clean musk base — the Silver Mountain Water target. The most office-appropriate release in the Club de Nuit range.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  },
  {
    ...
    rationale: 'Saline citrus over iris and ambergris — the Millésime Impérial reading. Lighter than the rest of the line and the pick for warm weather.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
  },
  {
    ...
    baseNotes: ['Ambroxan', 'Amber', 'Musk', 'Woody Notes'],
    rationale: 'Sharp citrus into a loud ambroxan base. Not a direct clone of anything, and the release enthusiasts most often defend on its own merits rather than as an alternative to something else.',
    intensity: 4,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
  },
  {
    ...
    occasion: ['Date Night', 'Everyday'],
    season: ['Fall', 'Winter'],
    topNotes: ['Orange', 'Bergamot', 'Blackcurrant'],
    heartNotes: ['Rose', 'Jasmine', 'Litchi'],
    baseNotes: ['Patchouli', 'Vanilla', 'Vetiver', 'Musk'],
    rationale: 'The Coco Mademoiselle target — citrus and rose over a patchouli-vanilla base. Strong performance for the price, with the same broad appeal that made the original a counter staple.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
  ...
  },
  {
    ...
    season: ['Spring', 'Summer'],
    topNotes: ['Pineapple', 'Iris', 'Ginger', 'Cypress'],
    heartNotes: ['Coconut', 'Woodsy Notes'],
    baseNotes: ['Tonka Bean', 'Sandalwood', 'Amber', 'Ambergris'],
    ...
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Beau-Le-Parfum-72158.html',
  },
  {
    ...
    heartNotes: ['Plum'],
    baseNotes: ['Tonka Bean'],
    rationale: 'Spiced plum and lavender over dense tonka: Le Male Elixir made richer and fruitier.',
    intensity: 5,
    longevity: '10-12 hrs',
    sillage: 'Very Strong',
    projection: 5,
    line: 'Le Male',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Male-Elixir-Absolu-101529.html',
    ingredients: [
      'Alcohol Denat.', 'Parfum (Fragrance)', 'Aqua (Water)',
      'Tetramethyl Acetyloctahydronaphthalenes', 'Linalyl Acetate', 'Linalool', 'Coumarin',
      'Vanillin', 'Butyl Methoxydibenzoylmethane', 'Hexamethylindanopyran',
      'Citrus Aurantium Bergamia (Bergamot) Peel Oil', 'Lavandula Oil/Extract',
      'Alpha-Isomethyl Ionone', 'Limonene', 'Pogostemon Cablin Oil',
      'Mentha Viridis (Spearmint) Leaf Oil', 'Carvone', 'Pinene', 'Beta-Caryophyllene',
      'Cinnamal', 'Camphor', 'Alcohol', 'Rose Ketones', 'Geranyl Acetate',
      'Tris (Tetramethylhydroxypiperidinol) Citrate', 'Terpineol', 'Geraniol', 'Terpinolene',
      'Farnesol', 'Citral', 'Sclareol', 'Alpha-Terpinene', 'Benzyl Benzoate', 'Menthol',
      'CI 19140 (Yellow 5)', 'CI 14700 (Red 4)', 'CI 60730 (Ext. Violet 2)',
    ],
    ingredientsSource: 'https://microperfumes.com/products/le-male-elixir-absolu-sample-vial',
  },
  {
    ...
    occasion: ['Everyday'],
    season: ['Spring', 'Summer'],
    topNotes: ['Green Notes', 'Watery Notes', 'Mint', 'Ginger'],
    heartNotes: ['Coconut', 'Fig', 'Salt'],
    baseNotes: ['Tonka Bean', 'Sandalwood'],
    rationale: 'Salty coconut and green fig over tonka: the freshest, greenest Le Beau.',
    intensity: 3,
    longevity: '6-8 hrs',
    sillage: 'Moderate',
    projection: 3,
    line: 'Le Beau',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/Le-Beau-Paradise-Garden-88836.html',
  },
  {
    id: 'jpg-la-belle',
    name: 'La Belle',
    ...
    season: ['Fall', 'Winter'],
    topNotes: ['Pear', 'Bergamot'],
    heartNotes: ['Floral Notes', 'Leather'],
    baseNotes: ['Vanilla', 'Vetiver', 'Amber', 'Musk'],
    rationale: 'Juicy pear over warm vanilla and vetiver; the original of the La Belle line.',
    intensity: 4,
    longevity: '8-10 hrs',
    sillage: 'Strong',
    projection: 4,
    line: 'La Belle',
    source: 'https://www.fragrantica.com/perfume/Jean-Paul-Gaultier/La-Belle-55786.html',
  },
  {
  ...
  // ---- Ladder completions, round 2 ----
  {
    ...
    sillage: 'Strong',
    projection: 4,
    source: 'https://www.fragrantica.com/perfume/Dior/Fahrenheit-Le-Parfum-23099.html',
  },
  {
